  ...
  const handleOnlinePayment = async () => {
    ...
    try {
      ...
      const adjustedTotalAmount =
        totalPrice < minimumAmountInINR ? minimumAmountInINR : totalPrice;
      ...
      <div className="container mx-auto p-4 flex flex-col lg:flex-row w-full gap-5 justify-between">
        ...
        {deliveryType === "schedule" && deliverySlot && (
          <p className="text-sm text-gray-500 text-center mt-2">
            You selected the <strong>{deliverySlot}</strong> slot — items will
            be delivered by{" "}
            <strong>
        ...
        {deliveryType === "instant" && (
          <p className="text-sm text-gray-500 text-center mt-2">
            ...
            delivered within <strong>90 minutes</strong>.
          </p>
        )}
      </div>
