    ...
    <section className="w-full bg-white py-10 px-4 md:px-20 mb-10 rounded-3xl">
      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row gap-6 md:gap-10 items-stretch">
        ...
        <motion.div
          ...
          className="flex-1"
        >
          <div className="shadow-lg rounded-xl p-6 border-2 border-green-400 bg-red-100 h-full flex flex-col justify-between">
            <p className="text-xl font-bold text-red-700 mb-4">
              Problem Statement
            </p>
            <div className="text-gray-900 text-md font-medium text-justify space-y-5">
              <p>
        ...
        <motion.div
          ...
          className="flex-1"
        >
          <div className="shadow-lg rounded-xl p-6 border-2 border-green-400 bg-green-100 h-full flex flex-col justify-between">
            <p className="text-xl font-bold text-red-700 mb-4">Solution</p>
            <div className="text-gray-900 text-md font-medium text-justify space-y-5">
              <p>
